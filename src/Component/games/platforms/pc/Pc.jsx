...
export default function Pc() {
  ...
  async function getdata() {
    let { data } = await axios.get(`https://free-to-play-games-database.p.rapidapi.com/api/games?platform=pc&rapidapi-key=b52128808dmsh5826403ec30ac21p1b9548jsnfca5769e0b68`)
